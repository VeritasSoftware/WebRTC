...
function handleStop(event) {
    ...
    recordedBlobs.forEach(async b => {
        ...
        let base64 = uint8ArrayToBase64(view);
        console.log("Converted to base64: ", base64);
        window.Recording(base64, b.type, true); 
    });
...
function handleStopRemote(event) {
    ...
    recordedBlobsRemote.forEach(async b => {
        ...
        let base64 = uint8ArrayToBase64(view);
        console.log("Converted to base64: ", base64);
        window.Recording(base64, b.type, false);       
    });
...
export async function startLocalScreenMedia(startAudio = false) {
    try {
        ...
        const displayMediaOptions = {
            ...
            startAudio: false // Set to true if you want to include system audio
        };
